...
public class SceneMove : MonoBehaviour
{
    ...
    public string targetSceneName = "초기 복도"; // 이동할 맵 씬 이름
    public string currentSceneName = "개인감옥"; // 현재 씬 이름
    ...
    void Update()
    {
        // 플레이어의 x 좌표가 targetSceneTransitionX 이상일 때 이동할 맵 씬으로 전환
        ...
        {
            SceneManager.LoadScene(currentSceneName); // 개인감옥 씬으로 전환
        }
    }
}
